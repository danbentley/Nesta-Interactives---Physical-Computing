define(['lib/jquery.transit.min'], function() {
	...
	Robot.prototype.move = function() {
		...
		if (this.isGoalReached) {
			return this.makeMove(newPosition);
		}
		...
		if (!this.canMoveToPosition(newPosition, this.direction)) return;

		this.makeMove(newPosition);
	};

	Robot.prototype.makeMove = function(newPosition) {
	...
	Robot.prototype.goalReached = function() {
